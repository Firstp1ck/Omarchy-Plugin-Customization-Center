...
ColumnLayout {
    ...
    signal reviewChanged(bool commandsReviewed)
    ...
    Ui.ToggleSwitch { visible: (review.commands || []).length > 0; checked: root.commandsReviewed; onToggled: root.reviewChanged(checked) }
